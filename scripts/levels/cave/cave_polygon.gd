...
func apply_texture(polygon: Polygon2D) -> void:
	...
	if polygon.polygon.size() > 0:
		var rect : Rect2 = get_polygon_rect(polygon.polygon)
...
func create_collision(polygon: Polygon2D) -> void:
